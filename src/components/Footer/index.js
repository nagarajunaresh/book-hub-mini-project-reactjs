      ...
      return (
        <div className="footer-container">
          <div className="icons-container">
            <a
              href="mailto:nagarajunaresh83@gmail.com"
              className="footer-icon-button"
            >
              <FaGoogle className={`footer-icon ${footerDarkText}`} />
            </a>
            <a
              href="https://www.linkedin.com/in/nagarajue/"
              target="__blank"
            ...
            <a
              href="https://github.com/nagarajunaresh"
              target="__blank"
              rel="noopener noreferrer"
              className="footer-icon-button"
            >
            ...
            <a
              href="https://www.instagram.com/nagaraju_naresh/"
              target="__blank"
              rel="noopener noreferrer"
              type="button"
              className="footer-icon-button"
            ...
            <a
              href="https://www.youtube.com/@Elavena_Nagaraju"
              target="__blank"
              rel="noopener noreferrer"
              type="button"
              className="footer-icon-button"
